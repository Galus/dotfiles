  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      local servers = {
        -- marksman = {},
        rust_analyzer = {},
        -- zk = {}, >>>>>>>> zk-nvim calls require('lspconfig').zk.setup() for me
        -- clangd = {},
        -- gopls = {},
        -- pyright = {},
        -- rust_analyzer = {},
...
vim.keymap.set('v', 'J', ":m '>+1<CR>gv=gv", { desc = 'Visual block move down' })
vim.keymap.set('v', 'K', ":m '<-2<CR>gv=gv", { desc = 'Visual block move up' })

-- disable 's' substitute for mini.surround
...
-- end
-- vim.api.nvim_create_user_command('GalusPres', galuspres, {})
